    ...
    <body>
        ...
        $query = $database->prepare("SELECT x.online_id AS player_name, id AS game_id, name AS game_name FROM trophy_title
            JOIN (
                ...
                OR (te.np_communication_id = 'NPWR05839_00' AND te.group_id = 'default' AND te.order_id = 0)
                ...
                OR (te.np_communication_id = 'NPWR00345_00' AND te.group_id = 'default' AND te.order_id = 41 AND te.earned_date >= '2012-11-16')
                ...
                OR (te.np_communication_id = 'NPWR14225_00' AND te.group_id = 'default' AND te.order_id = 6 AND te.earned_date <= '2020-04-12')
                ...
                OR (te.np_communication_id = 'NPWR18341_00' AND te.group_id = 'default' AND te.order_id = 0 AND te.earned_date < '2020-03-01')
                ...
                OR (te.np_communication_id = 'NPWR18992_00' AND te.group_id = 'default' AND te.order_id = 0)
                OR (te.np_communication_id = 'NPWR18992_00' AND te.group_id = 'default' AND te.order_id = 23)
                OR (te.np_communication_id = 'NPWR17688_00' AND te.group_id = 'default' AND te.order_id = 0)
                OR (te.np_communication_id = 'NPWR17688_00' AND te.group_id = 'default' AND te.order_id = 23)
                OR (te.np_communication_id = 'NPWR13165_00' AND te.group_id = '001' AND te.order_id = 31)
