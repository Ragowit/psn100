...
if (ctype_digit(strval($_POST["trophyparent"])) && ctype_digit(strval($_POST["trophychild"]))) {
    ...
    $query->bindParam(":child_trophy_id", $trophyChildId, PDO::PARAM_INT);
    ...
    while ($player = $players->fetch()) {
        ...
        $childTrophies->bindParam(":child_trophy_id", $trophyChildId, PDO::PARAM_INT);
        ...
        $titles = $database->prepare("SELECT DISTINCT parent_np_communication_id
            ...
            WHERE  child_np_communication_id = (SELECT np_communication_id
                                                FROM   trophy
                                                WHERE  id = :child_trophy_id) ");
        $titles->bindParam(":child_trophy_id", $trophyChildId, PDO::PARAM_INT);
        $titles->execute();
...
<html lang="en">
    ...
    <body>
        ...
        <form method="post">
            ...
            Trophy Child ID:<br>
            <input type="number" name="trophychild"><br>
            Trophy Parent ID:<br>
